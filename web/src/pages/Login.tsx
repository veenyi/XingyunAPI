    ...
    <div className="jc-auth-bg">
      <Tooltip title="去 GitHub Star 支持我们">
        <a
          ...
          onMouseEnter={e => (e.currentTarget.style.color = 'var(--jc-fg)')}
      ...
      <div className="jc-auth-card">
        <div className="jc-auth-logo">
          <img src="/logo.png" alt="行云API" style={{ width: 56, height: 56, objectFit: "contain", borderRadius: 12 }} />
        </div>
        <div style={{ textAlign: 'center', marginBottom: 28 }}>
          <Title level={3} style={{ marginBottom: 4 }}>行云API</Title>
        ...
        <div style={{ textAlign: 'center', marginTop: 16 }}>
          <Link
            to="/forgot-password"
            style={{ color: 'var(--jc-fg-muted)', fontSize: 13, display: 'inline-flex', alignItems: 'center', gap: 4, transition: 'color 200ms ease' }}
          >
